package com.dankee.camera_spike;
...
import com.dankee.camera_spike.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.dankee.camera_spike.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.dankee.camera_spike.MainActivity");
